    ...
    >
      <nav>
        ...
        >
          ...
          <Link href='/custom'><button className="flex items-center py-2 mt-2 px-4 gap-2 text-black bg-white border rounded-lg hover:bg-gray-900 hover:text-white" style={{ borderColor: "#FFD700" }}>
  <FaHammer />
  Custom
</button>
          </Link>  
