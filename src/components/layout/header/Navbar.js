    ...
    >
      <nav>
        ...
        >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-12 h-[53px] gap-15px lg:bg-[#EC9931]">
            {/* navbar left */}
            <NavbarLogo />
            {/* Main menu */}
            {isHome2Dark ? <NavItems2 /> : <NavItems />}
          <Link href='/custom'><button className="flex items-center py-2 mt-[3.5px]  px-4 gap-2 text-black bg-white border rounded-lg hover:bg-gray-900 hover:text-white" style={{ borderColor: "#FFD700" }}>
  <FaHammer />
  Custom
</button>
          </Link>  
