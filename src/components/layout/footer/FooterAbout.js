...
const FooterAbout = () => {
  ...
  return (
    ...
    >
      ...
      MAS Leather Gloves offers a wide range of high-quality leather products, specializing in gloves, jackets, wallets, keychains, and belts. We are committed to providing durable and stylish leather materials for everyday use.
      </p>
